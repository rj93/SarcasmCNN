package io.rj93.sarcasm.iterators.providers;
...
public class MultiFileLabeledSentenceProvider implements LabeledSentenceProvider {
     ...
     */
    public MultiFileLabeledSentenceProvider(Map<String, List<File>> filesByLabel) {
     ...
     */
    public MultiFileLabeledSentenceProvider(Map<String, List<File>> filesByLabel, Random rng) {
        int totalCount = 0;
